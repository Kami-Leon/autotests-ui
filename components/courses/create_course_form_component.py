...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.title_input = (
            page.get_by_test_id('create-course-form-title-input').locator('input'))
        ...
        self.max_score_input = (
            page.get_by_test_id('create-course-form-max-score-input').locator('input'))
        self.min_score_input = (
            page.get_by_test_id('create-course-form-min-score-input').locator('input'))
